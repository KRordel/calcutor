<template>
    <section id="catalog" aria-labelledby="catalog-title" class="border-t border-gray-200 py-20 sm:py-32">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl sm:text-center">
                <h2 id="catalog-title" class="text-3xl font-medium tracking-tight text-gray-900">
                    Каталог
                </h2>
                <p class="mt-2 text-lg text-gray-600">
                    Каталог онлайн калькуляторов по различным тематикам. Для каждого калькулятора есть виджет, который можно бесплатно установить на любой сайт.
                </p>
            </div>
            <div class="mt-16">
                ...
                <div class="text-start grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 xl:gap-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Ипотечный калькулятор</h3>
                    </a>
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Кредитный калькулятор с досрочным погашением</h3>
                    </a>
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Калькулятор рефинансирования</h3>
                    </a>
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Калькулятор микрозаймов</h3>
                    </a>
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Калькулятор инфляции</h3>
                    </a>
                </div>
            </div>
            <div class="mt-16">
                ...
                <div class="text-start grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 xl:gap-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Калькулятор инвестиций</h3>
                    </a>
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Калькулятор доходности облигаций</h3>
                    </a>
                </div>
            </div>
            <div class="mt-16">
                ...
                <div class="text-start grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 xl:gap-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <a href="#" class="flex items-center justify-center p-4 text-center relative rounded-xl before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-primary-500 before:hover:shadow-lg">
                        <h3 class="text-base text-gray-900 font-medium">Калькулятор веса</h3>
                    </a>
                </div>
            </div>
        </div>
